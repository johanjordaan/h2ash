...
(function() {
  var NORMAL_ATMOSPHERE, NO_ATMOSPHERE, THICK_ATMOSPHERE, THIN_ATMOSPHERE, VERY_THICK_ATMOSPHERE, VERY_THIN_ATMOSPHERE, types;
  ...
  NO_ATMOSPHERE = {
    ...
    pressure: types.fixed({
      value: -4
    }),
    temperature_modifier: types.fixed({
      value: 1
    })
  };
  ...
  NORMAL_ATMOSPHERE = {
    name: types.fixed({
      value: 'Earth Standard Atmosphere'
    }),
    pressure: types.range({
      from: -1,
      to: 2
