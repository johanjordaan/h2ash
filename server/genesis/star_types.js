...
(function() {
  var A_CLASS, BLUE_SUPER_GIANT, B_CLASS, DWARF, F_CLASS, G_CLASS, K_CLASS, M_CLASS, O_CLASS, PositionTemplate, RED_GIANT, RED_SUPER_GIANT, StarTemplate, astronomy, nox, planet_types, star_name_gen, trig;
  ...
  StarTemplate = nox.create_template('StarTemplate', {
    ...
    planets: nox.select({
      ...
      values: [nox.probability(.1, planet_types.ASTEROID_BELT), nox.probability(.1, planet_types.SUB_LUNAR), nox.probability(.1, planet_types.LUNAR), nox.probability(.1, planet_types.SUPER_LUNAR), nox.probability(.1, planet_types.SUB_TERRAN), nox.probability(.1, planet_types.TERRAN), nox.probability(.1, planet_types.SUPER_TERRAN), nox.probability(.1, planet_types.SUB_JOVIAN), nox.probability(.1, planet_types.JOVIAN), nox.probability(.1, planet_types.SUPER_JOVIAN)]
    })
  });
  ...
  DWARF = nox.extend_template(StarTemplate, 'DWARF', {
    ...
    planets: {
      ...
      values: [nox.probability(.2, planet_types.ASTEROID_BELT), nox.probability(.8, planet_types.ASTEROID)]
    }
  });
