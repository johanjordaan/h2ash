...
(function() {
  var A_CLASS, BLUE_SUPER_GIANT, B_CLASS, DEFAULT_PLANET_LIST, DWARF, DWARF_PLANET_LIST, F_CLASS, G_CLASS, K_CLASS, M_CLASS, O_CLASS, RED_GIANT, RED_SUPER_GIANT, astronomy, planet_types, types;
  ...
  DEFAULT_PLANET_LIST = [
    {
      probability: 1 / 10,
      type: planet_types.ASTEROID_BELT
    }, {
      probability: 1 / 10,
      type: planet_types.SUB_LUNAR
    }, {
      probability: 1 / 10,
      type: planet_types.LUNAR
    }, {
      probability: 1 / 10,
      type: planet_types.SUPER_LUNAR
    }, {
      probability: 1 / 10,
      type: planet_types.SUB_TERRAN
    }, {
      probability: 1 / 10,
      type: planet_types.TERRAN
    }, {
      probability: 1 / 10,
      type: planet_types.SUPER_TERRAN
    }, {
      probability: 1 / 10,
      type: planet_types.SUB_JOVIAN
    }, {
      probability: 1 / 10,
      type: planet_types.JOVIAN
    }, {
      probability: 1 / 10,
      type: planet_types.SUPER_JOVIAN
    }
  ];
