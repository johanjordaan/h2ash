...
(function() {
  define(['../services/renderers'], function(renderers) {
    var ah, camera, cc, construct_sector, delta_phi, delta_r, delta_theta, height, i, pMaterial, particle, particleSystem, particles, phi_steps, r_steps, radius, sc, scale, scene, sector, theta_steps, width, _i, _len, _ref;
    camera = {};
    scene = {};
    particleSystem = {};
    sector = {};
    ...
    return function($scope, $timeout, renderers) {
      var renderer;
      $scope.speed = 0;
      renderer = renderers.create_renderer("galaxy", 320, 240, scene, camera, function() {
        particleSystem.rotation.y += $scope.speed;
        return particleSystem.rotation.x += $scope.speed;
      });
      $scope.inc_speed = function() {
        return $scope.speed += 0.001;
      };
      $scope.dec_speed = function() {
        return $scope.speed -= 0.001;
      };
