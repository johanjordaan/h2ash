...
(function() {
  define(['underscore', '../utils/cmap', '../utils/noise'], function(_, cmap, noise) {
    var generate_planet;
    return generate_planet = function(index, x_period, y_period, power, size) {
      ...
      for (_i = 0, _len = layers.length; _i < _len; _i++) {
        ...
        clouds = new THREE.Mesh(new THREE.SphereGeometry(110, 24, 24), new THREE.MeshPhongMaterial({
          map: cloud_texture,
          transparent: true
        }));
        planet.add(clouds);
