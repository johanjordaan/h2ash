...
(function() {
  define([], function() {
    var CMAP, combine_rgb_into_hex_color, generate, interpolate, interpolate_color, pixel, scale_color, split_hex_color_to_rbg, types;
    CMAP = function(width, height) {
      var data, ret_val, size;
      size = width * height;
    ...
    interpolate = function(from, to, val) {
      var ret_val;
