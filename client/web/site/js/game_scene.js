...
(function() {
  define(['underscore', 'THREE', 'OrbitControls', 'movement'], function(_, THREE, OrbitControls, movement) {
    ...
    GameObject = (function() {
      function GameObject(name, object, icon, update_fn) {
        var direction, max_angular_speed, max_speed, now;
        this.name = name;
        this.object = object;
        ...
        now = Date.now();
        this.movement = new movement.Movable(this.object.position, direction, max_speed, max_angular_speed, now);
        this.movement.set_speed(100);
        this.movement.set_angular_speed(Math.PI / 4);
      }

      GameObject.prototype.update = function(date) {};

      GameObject.prototype.update = function() {
        this.movement.update(Date.now());
    ...
    GameScene = (function() {
      ...
      GameScene.prototype.dbl_click = function(e) {
        ...
        return this.active_object.movement.set_target_position(direction.multiplyScalar(1000));
      };
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          if (object.icon != null) {
            ...
            if (v.z < 1) {
              ...
              _results.push(object.icon.object.position.set((this.width / 2) * v.x, (this.height / 2) * v.y, -1));
            } else {
